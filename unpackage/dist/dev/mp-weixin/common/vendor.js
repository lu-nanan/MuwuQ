...
function formatCSSStyleDeclaration(style2, depth) {
  return {
    type: "object",
    value: {
      properties: Object.entries(style2.$styles).map(([name, value]) => formatObjectProperty(name, value, depth + 1))
    }
  };
}
...
function initRuntimeSocketService() {
  const hosts = "192.168.52.1,192.168.142.1,10.68.73.229,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_Tjh3yw";
...
const pages = [
  new UTSJSONObject({
    path: "pages/index/login1",
    style: new UTSJSONObject({
      navigationBarTitleText: "1",
      backgroundColorContent: "#324148"
    })
  }),
  new UTSJSONObject({
  ...
  new UTSJSONObject({
    path: "pages/index/my",
    style: new UTSJSONObject({
      navigationBarTitleText: "uni-app 1",
      backgroundColorContent: "#fff3cd"
    })
  }),
  new UTSJSONObject({
    path: "pages/index/cloudpan",
    style: new UTSJSONObject({
      navigationBarTitleText: "uni-app 1",
      backgroundColorContent: "#fff3cd"
    })
