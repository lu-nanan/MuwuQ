...
open class GenPagesIndexLogin1 : BasePage {
            ...
            createElementVNode("view", utsMapOf("class" to "login-container"), utsArrayOf(
                createElementVNode("view", utsMapOf("class" to "login"), utsArrayOf(
                    createElementVNode("view", utsMapOf("class" to "box"), utsArrayOf(
                        createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("color" to "rgba(255,255,255,1)", "font-size" to "36px", "font-family" to "AlibabaPuHui", "line-height" to "50px"))), "登录", 4),
                        createElementVNode("text", utsMapOf("class" to "underline-text", "onClick" to fun(){
                            _ctx.goPage("./login2")
                        }
                        ), "验证码登录", 8, utsArrayOf(
                            "onClick"
                    ...
                    createElementVNode("input", utsMapOf("class" to "uni-input", "placeholder" to "账号")),
                    createElementVNode("input", utsMapOf("class" to "uni-input", "placeholder" to "密码")),
                    createElementVNode("view", utsMapOf("class" to "box"), utsArrayOf(
                        createVNode(_component_checkbox, utsMapOf("style" to normalizeStyle(utsMapOf("color" to "rgba(255,255,255,1)", "width" to "auto", "white-space" to "nowrap"))), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return utsArrayOf(
                                "自动登录"
                            )
                        }
                        ...
                        createElementVNode("text", utsMapOf("class" to "underline-text", "style" to normalizeStyle(utsMapOf("width" to "20%"))), "忘记密码?", 4)
                    )),
                    createElementVNode("button", utsMapOf("style" to normalizeStyle(utsMapOf("width" to "80%", "border-radius" to "30rpx", "background" to "#A4ADB3", "color" to "rgba(255,255,255,1)")), "onClick" to fun(){
                        _ctx.goPage("/pages/index/index")
                    }
                    ), "登录", 12, utsArrayOf(
                        "onClick"
                    )),
                    createElementVNode("text", utsMapOf("style" to normalizeStyle(utsMapOf("text-decoration-line" to "underline", "color" to "rgba(255,255,255,1)", "margin-top" to "auto")), "onClick" to fun(){
                        _ctx.goPage("./register")
                    }
                    ), "没有账号?", 12, utsArrayOf(
                        "onClick"
                    ))
