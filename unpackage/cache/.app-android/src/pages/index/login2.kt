...
open class GenPagesIndexLogin2 : BasePage {
        ...
        return createElementVNode("scroll-view", utsMapOf("style" to normalizeStyle(utsMapOf("flex" to "1"))), utsArrayOf(
            createElementVNode("view", utsMapOf("class" to "login-container"), utsArrayOf(
                createElementVNode("view", utsMapOf("class" to "login"), utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "box"), utsArrayOf(
                        createElementVNode("input", utsMapOf("class" to "uni-input", "placeholder" to "验证码", "style" to normalizeStyle(utsMapOf("width" to "50%"))), null, 4),
                        createElementVNode("button", utsMapOf("style" to normalizeStyle(utsMapOf("margin-right" to "12rpx", "font-size" to "12rpx", "border-radius" to "30rpx", "background" to "#A4ADB3", "color" to "rgba(255,255,255,1)"))), "获取验证码", 4)
                    )),
                    createElementVNode("view", utsMapOf("class" to "box"), utsArrayOf(
                        createVNode(_component_checkbox, utsMapOf("style" to normalizeStyle(utsMapOf("color" to "rgba(255,255,255,1)"))), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return utsArrayOf(
                                "自动登录"
                            )
                        }
                        ...
                        createElementVNode("text", utsMapOf("class" to "underline-text"), "忘记密码?")
                    )),
                    createElementVNode("button", utsMapOf("style" to normalizeStyle(utsMapOf("width" to "80%", "border-radius" to "30rpx", "background" to "#A4ADB3", "color" to "rgba(255,255,255,1)"))), "登录", 4),
